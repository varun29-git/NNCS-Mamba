...
# dataset.py creates the first bridge between the trusted MPC expert and the future dual-head Mamba model.

"""
1. Ask MPC what actions to take.
2. Record the resulting quadrotor trajectory.
3. Ask the STL monitor how safe/successful that trajectory was.
"""
